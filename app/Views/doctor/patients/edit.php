        ...
        <div class="card-body-modern">
            ...
            <form action="<?= site_url('doctor/patients/update/' . $patient['id']) ?>" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control-modern" id="firstname" name="firstname" 
                                   value="<?= old('firstname', $patient['firstname']) ?>" required placeholder="Enter first name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control-modern" id="lastname" name="lastname" 
                                   value="<?= old('lastname', $patient['lastname']) ?>" required placeholder="Enter last name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control-modern" id="contact" name="contact" 
                                   value="<?= old('contact', $patient['contact']) ?>" placeholder="09123456789">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control-modern" id="address" name="address" rows="3" 
                                  placeholder="Enter complete address" style="resize: vertical;"><?= old('address', $patient['address']) ?></textarea>
                ...
                <div class="d-flex justify-content-between flex-wrap gap-3">
                    <a href="<?= site_url('doctor/patients/view/' . $patient['id']) ?>" class="btn-modern btn-modern-secondary">
                        <i class="fas fa-arrow-left"></i>
                        Cancel
                    </a>
                    <div style="display: flex; gap: 12px;">
                        <a href="<?= site_url('doctor/patients/view/' . $patient['id']) ?>" class="btn-modern btn-modern-info">
