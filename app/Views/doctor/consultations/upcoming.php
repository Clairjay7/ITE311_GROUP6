...
<?= $this->section('title') ?>Upcoming Consultations<?= $this->endSection() ?>
...
<div class="doctor-page-container">
    <div class="page-header">
        ...
        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
            <a href="<?= site_url('doctor/consultations/my-schedule') ?>" class="btn-modern btn-modern-info">
        ...
        <div class="card-body-modern">
                        ...
                        <tbody>
                            <?php foreach ($consultations as $consultation): ?>
                                <tr>
                                    ...
                                    <td><?= esc(substr($consultation['notes'] ?? 'No notes', 0, 60)) ?><?= strlen($consultation['notes'] ?? '') > 60 ? '...' : '' ?></td>
                                    <td>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>You don't have any approved upcoming consultations.</p>
                    <a href="<?= site_url('doctor/consultations/create') ?>" class="btn-modern btn-modern-primary">
                        <i class="fas fa-plus"></i>
