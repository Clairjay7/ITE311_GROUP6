...
<?= $this->section('title') ?>Edit Medical Order<?= $this->endSection() ?>
...
<div class="doctor-page-container">
    ...
    <div class="modern-card">
        <form action="<?= site_url('doctor/orders/update/' . $order['id']) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="form-group-modern">
                ...
                <select name="patient_id" id="patient_id" class="form-control-modern" required>
                    ...
                    <?php foreach ($patients as $patient): ?>
                        <option value="<?= esc($patient['id']) ?>" <?= (old('patient_id', $order['patient_id']) == $patient['id']) ? 'selected' : '' ?>>
            ...
            <div class="form-group-modern">
                ...
                <select name="nurse_id" id="nurse_id" class="form-control-modern" required>
                    ...
                    <?php foreach ($nurses as $nurse): ?>
                        <option value="<?= esc($nurse['id']) ?>" <?= (old('nurse_id', $order['nurse_id'] ?? '') == $nurse['id']) ? 'selected' : '' ?>>
            ...
            <div class="form-group-modern">
                ...
                <select name="order_type" id="order_type" class="form-control-modern" required>
                    ...
                    <option value="medication" <?= (old('order_type', $order['order_type']) == 'medication') ? 'selected' : '' ?>>Medication</option>
                    <option value="lab_test" <?= (old('order_type', $order['order_type']) == 'lab_test') ? 'selected' : '' ?>>Lab Test</option>
                    <option value="procedure" <?= (old('order_type', $order['order_type']) == 'procedure') ? 'selected' : '' ?>>Procedure</option>
                    <option value="diet" <?= (old('order_type', $order['order_type']) == 'diet') ? 'selected' : '' ?>>Diet</option>
                    <option value="activity" <?= (old('order_type', $order['order_type']) == 'activity') ? 'selected' : '' ?>>Activity</option>
                    <option value="other" <?= (old('order_type', $order['order_type']) == 'other') ? 'selected' : '' ?>>Other</option>
                </select>
            ...
            <div class="form-group-modern">
                ...
                <textarea name="order_description" id="order_description" class="form-control-modern" rows="4" required><?= old('order_description', $order['order_description']) ?></textarea>
            ...
            <div class="form-group-modern">
                ...
                <textarea name="instructions" id="instructions" class="form-control-modern" rows="3"><?= old('instructions', $order['instructions']) ?></textarea>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group-modern">
                        ...
                        <input type="text" name="frequency" id="frequency" class="form-control-modern" value="<?= old('frequency', $order['frequency']) ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group-modern">
                        ...
                        <input type="date" name="start_date" id="start_date" class="form-control-modern" value="<?= old('start_date', $order['start_date']) ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group-modern">
                ...
                <input type="date" name="end_date" id="end_date" class="form-control-modern" value="<?= old('end_date', $order['end_date']) ?>">
            </div>
