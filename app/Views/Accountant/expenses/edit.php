...
<div class="form-container">
    <h1 style="color: #2e7d32; margin-bottom: 24px;">Edit Expense</h1>
    ...
    <form method="POST" action="<?= site_url('accounting/expenses/update/' . $expense['id']) ?>">
        ...
        <div class="form-group">
            ...
            <select name="category" class="form-control" required>
                <option value="medical_supplies" <?= old('category', $expense['category']) == 'medical_supplies' ? 'selected' : '' ?>>Medical Supplies</option>
        ...
        <div style="display: flex; gap: 12px; margin-top: 24px;">
            ...
            <a href="<?= site_url('accounting/expenses') ?>" class="btn-cancel">Cancel</a>
        </div>
    </form>
</div>
<?= $this->endSection() ?>
