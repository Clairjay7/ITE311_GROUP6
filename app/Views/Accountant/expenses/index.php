...
<div class="page-header">
    ...
    <a href="<?= site_url('accounting/expenses/create') ?>" class="btn-primary">
            ...
            <?php if (!empty($expenses)): ?>
                <?php foreach ($expenses as $expense): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= site_url('accounting/expenses/edit/' . $expense['id']) ?>" style="color: #0288d1; margin-right: 8px;">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="<?= site_url('accounting/expenses/delete/' . $expense['id']) ?>" 
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" style="text-align: center; padding: 40px; color: #94a3b8;">
                        No expenses found. <a href="<?= site_url('accounting/expenses/create') ?>">Create one now</a>.
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
