...
<div class="modern-card">
    ...
    <div class="card-body-modern">
        <?php if (!empty($pendingCharges)): ?>
            ...
            <form action="<?= site_url('accounting/discharge/process/' . $admission['id']) ?>" method="post" style="margin-top: 24px;">
                <?= csrf_field() ?>
                <div style="display: flex; gap: 12px; justify-content: flex-end;">
                    <a href="<?= site_url('accounting/dashboard') ?>" class="btn-modern btn-secondary">
