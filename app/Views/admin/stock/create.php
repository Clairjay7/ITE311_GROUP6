...
<div class="admin-module">
    ...
    <form method="POST" action="<?= base_url('admin/stock/store') ?>" class="form-container">
        ...
        <div class="form-group">
            ...
            <input type="number" id="threshold" name="threshold" min="0" class="form-control" value="<?= old('threshold') ?>" required>
        </div>
