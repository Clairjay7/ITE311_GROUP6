...
<?= $this->section('title') ?>Edit Nurse Schedule<?= $this->endSection() ?>
...
<div class="admin-module">
    <div class="module-header">
        <h2><i class="fas fa-user-nurse"></i> Edit Nurse Schedule</h2>
    ...
    <form method="POST" action="<?= base_url('admin/nurse-schedules/update/' . $schedule['id']) ?>" class="form-container" id="scheduleForm">
        <div class="form-group">
            ...
            <select id="nurse_id" name="nurse_id" class="form-control <?= isset($errors['nurse_id']) ? 'is-invalid' : '' ?>" required>
                ...
                <?php foreach ($nurses as $nurse): ?>
                    <option value="<?= esc($nurse['id']) ?>" <?= old('nurse_id', $schedule['nurse_id']) == $nurse['id'] ? 'selected' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="hidden" id="shift_type" name="shift_type" value="<?= old('shift_type', $schedule['shift_type']) ?>" required>
