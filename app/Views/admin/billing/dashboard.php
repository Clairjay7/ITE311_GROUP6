...
<style>
    ...
    <div class="dashboard-header">
        <h1>Billing Service Dashboard</h1>
        <p class="dashboard-subtitle">Financial Management & Billing</p>
    </div>

    <!-- Quick Actions -->
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 24px;">
        <a href="<?= base_url('admin/billing/charges') ?>" style="background: #dc2626; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08); position: relative;">
        ...
        <a href="<?= base_url('admin/billing/finance') ?>" style="background: #2e7d32; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <i class="fas fa-chart-line" style="font-size: 24px; margin-bottom: 8px; display: block;"></i>
            Finance Overview
        </a>
        <a href="<?= base_url('admin/billing/payment_reports') ?>" style="background: #0288d1; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <i class="fas fa-money-bill-wave" style="font-size: 24px; margin-bottom: 8px; display: block;"></i>
            Payment Reports
        </a>
        <a href="<?= base_url('admin/billing/expenses') ?>" style="background: #f59e0b; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <i class="fas fa-receipt" style="font-size: 24px; margin-bottom: 8px; display: block;"></i>
            Expense Tracking
        </a>
        <a href="<?= base_url('admin/billing/discharge') ?>" style="background: #f59e0b; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
            <i class="fas fa-sign-out-alt" style="font-size: 24px; margin-bottom: 8px; display: block;"></i>
            Discharge Billing
        </a>
        <a href="<?= base_url('admin/billing/patient_billing') ?>" style="background: #8b5cf6; color: white; padding: 16px; border-radius: 12px; text-decoration: none; text-align: center; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
    ...
    <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 2px 6px rgba(15, 23, 42, 0.08);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
            ...
            <a href="<?= base_url('admin/billing/charges') ?>" style="color: #dc2626; text-decoration: none; font-weight: 600; font-size: 14px;">
...
document.addEventListener('DOMContentLoaded', function() {
    const accountantStatsEndpoint = '<?= base_url('admin/billing/dashboard/stats') ?>';
    ...
    async function loadPendingCharges(charges) {
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: start;">
                        ...
                        <div style="text-align: right;">
                            ...
                            <div style="margin-top: 8px;">
                                <a href="<?= base_url('admin/billing/charges/view/') ?>${charge.id}" style="color: #0288d1; text-decoration: none; font-size: 12px; font-weight: 600;">
        ...
        if (charges.length > 5) {
            html += `<p style="text-align: center; margin-top: 12px; color: #64748b; font-size: 14px;">
                ...
                <a href="<?= base_url('admin/billing/charges') ?>" style="color: #dc2626; text-decoration: none; font-weight: 600;">View All</a>
            </p>`;
        }
                ...
                <div style="border: 1px solid #fef3c7; border-radius: 8px; padding: 16px; background: #fffbeb;">
                    <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 12px;">
                        ...
                        <div style="text-align: right;">
                            ...
                            <a href="<?= base_url('admin/billing/discharge/finalize/') ?>${discharge.id}" 
