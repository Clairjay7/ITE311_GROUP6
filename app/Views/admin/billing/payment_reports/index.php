...
<div class="page-header">
    ...
    <a href="<?= base_url('admin/billing/payment_reports/create') ?>" class="btn-primary">
                ...
                <tbody>
                    <?php foreach ($medication_payments as $report): ?>
                        <tr style="background: <?= $report['status'] === 'completed' ? '#f0fdf4' : ''; ?>">
                            ...
                            <td>
                                <a href="<?= base_url('admin/billing/payment_reports/edit/' . $report['id']) ?>" style="color: #0288d1; margin-right: 8px;">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="<?= base_url('admin/billing/medication-billing/view/' . $report['billing_id']) ?>" style="color: #10b981; margin-right: 8px;">
                    ...
                    <?php foreach ($payment_reports as $report): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/billing/payment_reports/delete/' . $report['id']) ?>" 
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 40px; color: #94a3b8;">
                            No payment reports found. <a href="<?= base_url('admin/billing/payment_reports/create') ?>">Create one now</a>.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
