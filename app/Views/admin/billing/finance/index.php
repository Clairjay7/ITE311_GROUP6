...
<div class="page-header">
    ...
    <a href="<?= base_url('admin/billing/finance/create') ?>" class="btn-primary">
            ...
            <?php if (!empty($finance_overviews)): ?>
                <?php foreach ($finance_overviews as $overview): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('admin/billing/finance/edit/' . $overview['id']) ?>" style="color: #0288d1; margin-right: 8px;">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="<?= base_url('admin/billing/finance/delete/' . $overview['id']) ?>" 
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" style="text-align: center; padding: 40px; color: #94a3b8;">
                        No finance overview records found. <a href="<?= base_url('admin/billing/finance/create') ?>">Create one now</a>.
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
