...
<div style="margin-top: 24px;">
    <a href="<?= base_url('admin/billing/charges') ?>" class="btn-action btn-back">
        <i class="fas fa-arrow-left"></i> Back to List
    </a>
    <?php if ($charge['status'] === 'paid'): ?>
        <a href="<?= base_url('admin/billing/charges/invoice/' . $charge['id']) ?>" class="btn-action btn-invoice" target="_blank">
