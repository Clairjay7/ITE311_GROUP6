...
<div class="admin-module">
    ...
    <form method="POST" action="<?= base_url('admin/system/update/' . $setting['id']) ?>" class="form-container">
        <div class="form-group">
            <label for="setting_name">Setting Name *</label>
            <input type="text" id="setting_name" name="setting_name" class="form-control" value="<?= old('setting_name', $setting['setting_name']) ?>" required>
        </div>

        <div class="form-group">
            <label for="setting_value">Setting Value *</label>
            <textarea id="setting_value" name="setting_value" class="form-control" rows="4" required><?= old('setting_value', $setting['setting_value']) ?></textarea>
        </div>
