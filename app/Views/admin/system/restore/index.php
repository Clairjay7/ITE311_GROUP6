...
<div class="it-page-container">
    ...
    <div class="modern-card">
        <h3 style="color: #f59e0b; margin-bottom: 24px; display: flex; align-items: center; gap: 10px;">
            ...
            Available Backups (<?= count($backups) ?>)</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (file_exists($backup['file_path'])): ?>
                                        <form action="<?= base_url('admin/system/restore/restore/' . $backup['id']) ?>" method="post" style="display: inline;" onsubmit="return confirm('WARNING: This will restore the system from this backup. All current data will be overwritten. Are you absolutely sure you want to proceed?');">
                                            <?= csrf_field() ?>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 40px; color: #94a3b8;">
                                ...
                                <a href="<?= base_url('admin/system/backup') ?>" style="color: #0288d1; text-decoration: none; font-weight: 600; margin-top: 16px; display: inline-block;">
