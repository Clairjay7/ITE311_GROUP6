...
<div class="it-page-container">
    ...
    <div class="modern-card">
        <h3 style="color: #0288d1; margin-bottom: 24px; display: flex; align-items: center; gap: 10px;">
            ...
            Existing Backups (<?= count($backups) ?>)</h3>
                                ...
                                <td>
                                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                                        <?php if ($backup['status'] == 'completed' && file_exists($backup['file_path'])): ?>
                                            <a href="<?= base_url('admin/system/backup/download/' . $backup['id']) ?>" class="btn-sm-modern btn-success">
                                                <i class="fas fa-download"></i>
                                                Download
                                            </a>
                                        <?php endif; ?>
                                        <a href="<?= base_url('admin/system/backup/delete/' . $backup['id']) ?>" class="btn-sm-modern btn-danger" onclick="return confirm('Are you sure you want to delete this backup?')">
