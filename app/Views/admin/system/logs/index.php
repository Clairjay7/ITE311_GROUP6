...
<div class="it-page-container">
    ...
    <div class="filter-card">
        <form method="get" action="<?= base_url('admin/system/logs') ?>" class="filter-form">
            ...
            <div class="form-group-modern">
                <a href="<?= base_url('admin/system/logs') ?>" class="btn-modern btn-modern-secondary" style="width: 100%;">
    ...
    <div class="modern-card">
        <div style="padding: 20px; border-bottom: 2px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center;">
            ...
            <form action="<?= base_url('admin/system/logs/clear') ?>" method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to clear old logs? This action cannot be undone.');">
                <?= csrf_field() ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 8px;">
                                        <a href="<?= base_url('admin/system/logs/view/' . $log['id']) ?>" class="btn-sm-modern btn-info">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url('admin/system/logs/delete/' . $log['id']) ?>" class="btn-sm-modern btn-danger" onclick="return confirm('Are you sure you want to delete this log entry?')">
                                            <i class="fas fa-trash"></i>
                                        </a>
                                    </div>
                                </td>
