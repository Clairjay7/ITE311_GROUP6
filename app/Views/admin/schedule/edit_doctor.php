...
<div class="admin-module">
    <div class="module-header">
        <h2><?= esc($title) ?></h2>
        <a href="<?= base_url('admin/schedule/view/' . $schedule['doctor_id'] . '?role=doctor') ?>" class="btn btn-secondary">
    ...
    <div class="schedule-form-container">
        <div class="doctor-info-card">
            ...
            <?php if (isset($doctor['specialization'])): ?>
                <p><strong>Specialization:</strong> <?= esc($doctor['specialization']) ?></p>
            <?php endif; ?>
            <p><strong>Email:</strong> <?= esc($doctor['email']) ?></p>
        </div>

        <form method="post" action="<?= base_url('admin/schedule/update/' . $schedule['id'] . '?role=doctor') ?>" class="schedule-form">
            <?= csrf_field() ?>
