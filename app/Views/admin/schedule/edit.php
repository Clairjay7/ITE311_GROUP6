...
<div class="admin-module">
    ...
    <form method="POST" action="<?= base_url('admin/schedule/update/' . $schedule['id']) ?>" class="form-container">
        <div class="form-group">
            <label for="patient_id">Patient *</label>
            <select id="patient_id" name="patient_id" class="form-control" required>
                <option value="">Select Patient</option>
                <?php foreach ($patients as $patient): ?>
                    <option value="<?= esc($patient['id']) ?>" <?= old('patient_id', $schedule['patient_id']) == $patient['id'] ? 'selected' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="time" id="time" name="time" class="form-control" value="<?= old('time', $schedule['time']) ?>" required>
        </div>

        <div class="form-group">
            <label for="doctor">Doctor *</label>
            <input type="text" id="doctor" name="doctor" class="form-control" value="<?= old('doctor', $schedule['doctor']) ?>" required>
        </div>
