...
<div class="container py-4">
  <div class="mb-3 d-flex justify-content-between align-items-center">
    <h3 class="mb-0">Register Patient</h3>
  ...
  <div class="card shadow-sm">
    <div class="card-body">
      <form method="post" action="/receptionist/patients/store">
        <?= csrf_field() ?>
        <div class="row g-3">
          <div class="col-md-6">
            <label class="form-label">Full Name<span class="text-danger">*</span></label>
            <input type="text" name="full_name" class="form-control <?= isset($errors['full_name'])?'is-invalid':'' ?>" value="<?= set_value('full_name') ?>">
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="age" class="form-control <?= isset($errors['age'])?'is-invalid':'' ?>" value="<?= set_value('age') ?>">
          ...
          <div class="col-12">
            ...
            <textarea name="purpose" class="form-control" rows="3"><?= set_value('purpose') ?></textarea>
          </div>
