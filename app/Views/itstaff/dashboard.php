...
<div class="dashboard-container">
    ...
    <div class="welcome-section">
        <h2>Welcome, <?= esc($name ?? 'IT Staff') ?></h2>
    ...
    <div class="welcome-section" style="margin-top: 24px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
            <a href="<?= site_url('it/logs') ?>" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
            ...
            <a href="<?= site_url('it/users') ?>" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
            ...
            <a href="<?= site_url('it/backup') ?>" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
            ...
            <a href="<?= site_url('it/restore') ?>" class="stat-card" style="text-decoration: none; color: inherit; display: block;">
    ...
    <div class="welcome-section" style="margin-top: 24px;">
        ...
        <p style="color: #64748b; font-size: 14px; margin-bottom: 20px;">
            Monitor the health and activity of all system modules. IT Staff ensures all roles have stable access to their respective modules.
        </p>
    ...
    <div class="welcome-section" style="margin-top: 24px;">
        ...
        <div style="margin-top: 16px; text-align: right;">
            <a href="<?= site_url('it/logs') ?>" style="color: #2e7d32; text-decoration: none; font-weight: 600;">View All Logs →</a>
        </div>
    </div>
    <?php endif; ?>
</div>
